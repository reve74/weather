...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("areaIndex","UTF-8") + "=" + URLEncoder.encode("221251", "UTF-8")); /*측정소코드*/
        urlBuilder.append("&" + URLEncoder.encode("controlnumber","UTF-8") + "=" + URLEncoder.encode("2019101109", "UTF-8")); /*측정시간*/
