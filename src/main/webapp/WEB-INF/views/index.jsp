...
<html lang="en">
  <head>
    ...
    <title>Keep your weather</title>
    <link rel="stylesheet" href="${contextPath}/resources/main/fontawesome-5.5/css/all.min.css" />
    <link rel="stylesheet" href="${contextPath}/resources/main/slick/slick.css">
    <link rel="stylesheet" href="${contextPath}/resources/main/slick/slick-theme.css">
  ...
  <body>    
    ...
    <section id="hero" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">              
        <div class="container">   
          <div class="tm-next">
              <a href="#hero" class="navbar-brand">Today's weather</a>
          </div>             
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Today's weather</h2>
    ...
    <section id="introduction" class="tm-section-pad-top">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <img src="${contextPath}/resources/main/img/the-town-01.jpg" alt="Image" class="img-fluid tm-intro-img" />
          </div>
          <div class="col-lg-6">
            ...
            <div class="col-12">
                <div class="mx-auto tm-gallery-container">
                    <div class="grid tm-gallery">
                      <a href="${contextPath}/resources/main/img/gallery-img-01.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="${contextPath}/resources/main/img/gallery-tn-01.jpg" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Dreamy <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="${contextPath}/resources/main/img/gallery-img-02.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="${contextPath}/resources/main/img/gallery-tn-02.jpg" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Second <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="${contextPath}/resources/main/img/gallery-img-03.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="${contextPath}/resources/main/img/gallery-tn-03.jpg" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Third <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="${contextPath}/resources/main/img/gallery-img-04.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="${contextPath}/resources/main/img/gallery-tn-04.jpg" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Dreamy <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="${contextPath}/resources/main/img/gallery-img-05.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="${contextPath}/resources/main/img/gallery-tn-05.jpg" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Fifth <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="${contextPath}/resources/main/img/gallery-img-06.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="${contextPath}/resources/main/img/gallery-tn-06.jpg" alt="Image" class="img-fluid">
                          <figcaption>
    ...
    <script src="${contextPath}/resources/main/js/jquery-1.9.1.min.js"></script>     
    <script src="${contextPath}/resources/main/slick/slick.min.js"></script>
    <script src="${contextPath}/resources/main/magnific-popup/jquery.magnific-popup.min.js"></script>
    <script src="${contextPath}/resources/main/js/jquery.singlePageNav.min.js"></script>     
    <script src="${contextPath}/resources/main/js/bootstrap.min.js"></script> 
    <script>
